...
C_SRCS += \
D:/githubs/fmc-320u/libs/fm_event/fm_event.c 

OBJS += \
./libs/fm_event/fm_event.o 

C_DEPS += \
./libs/fm_event/fm_event.d 


# Each subdirectory must supply rules for building sources it contributes
libs/fm_event/fm_event.o: D:/githubs/fmc-320u/libs/fm_event/fm_event.c libs/fm_event/subdir.mk
...
clean: clean-libs-2f-fm_event

clean-libs-2f-fm_event:
	-$(RM) ./libs/fm_event/fm_event.cyclo ./libs/fm_event/fm_event.d ./libs/fm_event/fm_event.o ./libs/fm_event/fm_event.su

.PHONY: clean-libs-2f-fm_event
