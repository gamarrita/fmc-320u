...
C_SRCS += \
D:/githubs/fmc-320u/libs/fm_factory/fm_factory.c 

OBJS += \
./libs/fm_factory/fm_factory.o 

C_DEPS += \
./libs/fm_factory/fm_factory.d 


# Each subdirectory must supply rules for building sources it contributes
libs/fm_factory/fm_factory.o: D:/githubs/fmc-320u/libs/fm_factory/fm_factory.c libs/fm_factory/subdir.mk
...
clean: clean-libs-2f-fm_factory

clean-libs-2f-fm_factory:
	-$(RM) ./libs/fm_factory/fm_factory.cyclo ./libs/fm_factory/fm_factory.d ./libs/fm_factory/fm_factory.o ./libs/fm_factory/fm_factory.su

.PHONY: clean-libs-2f-fm_factory
