    ...
    else
    {
        ...
        if (group_ptr->tx_event_flags_group_suspension_list != TX_NULL)
        {
            ...
            else
            {
                ...
                suspended_list =
                group_ptr->tx_event_flags_group_suspension_list;
                ...
                do
                {
                    ...
                    if (group_ptr->tx_event_flags_group_reset_search != TX_FALSE)
                    {
                        ...
                        current_event_flags = current_event_flags
                        | group_ptr->tx_event_flags_group_current;
                    }
                    ...
                    if (and_request == TX_AND)
                    {
                        ...
                        /* Calculate the flags present.  */
                        flags_satisfied =
                        (current_event_flags & requested_flags);
                    ...
                    if (flags_satisfied != ((ULONG) 0))
                    {
                        ...
                        else
                        {
                            ...
                            next_thread->tx_thread_suspended_previous =
                            previous_thread;
                            previous_thread->tx_thread_suspended_next =
                            next_thread;
                        ...
                        else
                        {
                            ...
                            last_satisfied->tx_thread_suspended_next =
                            thread_ptr;
                            thread_ptr->tx_thread_suspended_next = TX_NULL;
                            last_satisfied = thread_ptr;
                        }
