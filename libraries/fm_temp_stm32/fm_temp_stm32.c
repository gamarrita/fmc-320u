...
/*
 * @brief Función que toma la temperatura del micro en grados celcius y la
 * convierte en una string que se le pasa como parámetro.
 * @param String en la que se introduce la temperatura y su tamaño.
 * @retval None
 */
void fm_temp_stm32_format_str(char *ptr_str, int str_lgth)
{
    ...
    sprintf(ptr_str, "     %02d", fm_temp_stm32_format_int());
}

/*
 * @brief Función que configura el ADC 1 asociado al sensor de temperatura y lo
 * lee una vez.
 * @param None
 * @retval None
 */
